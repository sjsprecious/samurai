...
ReferenceState::ReferenceState(const std::string& config)
{
  ...
  if (!refstream.good())
  {
    ...
    theta.push_back(298.6949);
    qv.push_back(bhypTransform(18.63960));
    altitude.push_back(log(124.0));
    theta.push_back(299.6500);
    qv.push_back(bhypTransform(18.58188));
    altitude.push_back(log(810.0));
    theta.push_back(301.688);
    qv.push_back(bhypTransform(15.30626));
    altitude.push_back(log(1541.0));
    theta.push_back(304.5541);
    qv.push_back(bhypTransform(11.98349));
    altitude.push_back(log(3178.0));
    theta.push_back(312.2750);
    qv.push_back(bhypTransform(6.76311));
    altitude.push_back(log(4437.0));
    theta.push_back(317.8749);
    qv.push_back(bhypTransform(4.15019));
    altitude.push_back(log(5887.0));
    theta.push_back(324.8602);
    qv.push_back(bhypTransform(2.42535));
    altitude.push_back(log(7596.0));
    theta.push_back(332.5846);
    qv.push_back(bhypTransform(1.11535));
    altitude.push_back(log(9690.0));
    theta.push_back(339.6121);
    qv.push_back(bhypTransform(0.32924));
    altitude.push_back(log(10949.0));
    theta.push_back(342.8986);
    qv.push_back(bhypTransform(0.13712));
    altitude.push_back(log(12418.0));
    theta.push_back(346.4510);
    qv.push_back(bhypTransform(0.04282));
    altitude.push_back(log(14203.0));
    theta.push_back(353.9290);
    qv.push_back(bhypTransform(0.03));
    altitude.push_back(log(16590.0));
    theta.push_back(383.2672);
    qv.push_back(bhypTransform(0.03));
    altitude.push_back(log(20726.0));
    theta.push_back(494.1519);
    qv.push_back(bhypTransform(0.010));
    altitude.push_back(log(40000.0));
    theta.push_back(1010.8810);
    qv.push_back(bhypTransform(0.001));
  }
  else
  {
    altitude.push_back(log(10.0));
...
real ReferenceState::getReferenceVariable(const int& refVariable, const real& heightm, const int& dz)
{
  ...
  else
  {
    ...
    if (dz == 0)
    {
      switch (refVariable)
      {
        case rhoaref: return rhoa;
        case rhoref: return rho;
        case href: return h;
        case tempref: return temp;
        case pressref: return press;
        default: break;
      }
    }
    else
    {
      ...
      switch (refVariable)
      {
        case rhoaref: return drhoadz;
        case rhoref: return drhodz;
        case href: return dhdz;
        case tempref: return dtdz;
        case pressref: return dpadz;
        default: break;
      }
    }
  }
