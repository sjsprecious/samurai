...
bool CostFunctionCOAMPS::writeAsi(const std::string& asiFileName)
{
  ...
  for(int n = 0; n < id[175]; n++) {
          ...
          std::string name_2 = fieldNames.at(n).substr(fieldNames.at(n).length()/2,1);  // Possibly wrong; unsure how Qt's
  'mid' corresponds to a substr in the middle (C++11) int int_1 = *name_1.toLatin1().data(); int int_2 =
  *name_2.toLatin1().data(); id[176 + (5 * n)] = (int_1 * 256) + int_2; id[177 + (5 * n)] = 8224; id[178 + (5 * n)] = 8224;
          id[179 + (5 * n)] = 8224;
          id[180 + (5 * n)] = 1;
  }*/
