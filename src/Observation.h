...
class Observation
{
 public:
  Observation();
  ~Observation();
  double inline getRadius() const
  {
    return radius;
  }
  void setRadius(const double &r);

  double inline getTheta() const
  {
    return theta;
  }
  void setTheta(const double &t);

  double inline getAltitude() const
  {
    return altitude;
  }
  void setAltitude(const double &alt);

  double inline getCartesianX() const
  {
    return cartesianX;
  }
  void setCartesianX(const double &x);

  double inline getCartesianY() const
  {
    return cartesianY;
  }
  ...
  double inline getError() const
  {
    return error;
  }
  void setError(const double &err);

  double inline getOb() const
  {
    return obNet;
  }
  void setOb(const double &ob);

  int64_t inline getTime() const
  {
    return time;
  }
